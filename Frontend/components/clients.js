...
clientImg.forEach((url, index) => {
  ...
  logodivs.className = "w-[200px] h-[200px] shadow-xl object-contain object-center grayscale hover:grayscale-0 hover:scale-105 transition duration-300 ease-in-out cursor-pointer";
  logodivs.src = url;
